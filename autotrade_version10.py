...
def fetch_and_prepare_data():
    ...
    df_minute240_XEC = add_indicators_version4(df_minute240_XEC)
    df_minute240_CVC = add_indicators_version4(df_minute240_CVC)
    df_minute240_POLYX = add_indicators_version4(df_minute240_POLYX)
    df_minute240_T = add_indicators_version4(df_minute240_T)
    df_minute240_SHIB = add_indicators_version4(df_minute240_SHIB)
    df_minute240_BTC = add_indicators_version4(df_minute240_BTC)
    df_minute240_XRP = add_indicators_version4(df_minute240_XRP)
    df_minute240_DOGE = add_indicators_version4(df_minute240_DOGE)
    df_minute240_WAXP = add_indicators_version4(df_minute240_WAXP)
    df_minute240_CTC = add_indicators_version4(df_minute240_CTC)
    df_minute240_ANKR = add_indicators_version4(df_minute240_ANKR)
    df_minute240_AERGO = add_indicators_version4(df_minute240_AERGO)
    df_minute240_HIFI = add_indicators_version4(df_minute240_HIFI)
    df_minute240_SOL = add_indicators_version4(df_minute240_SOL)
    df_minute240_STMX = add_indicators_version4(df_minute240_STMX)
    df_minute240_ETH = add_indicators_version4(df_minute240_ETH)
    df_minute240_ID = add_indicators_version4(df_minute240_ID)
    df_minute240_NEAR = add_indicators_version4(df_minute240_NEAR)
    df_minute240_SC = add_indicators_version4(df_minute240_SC)
    df_minute240_BORA = add_indicators_version4(df_minute240_BORA)
    df_minute240_PYTH = add_indicators_version4(df_minute240_PYTH)
    df_minute240_LSK = add_indicators_version4(df_minute240_LSK)
    df_minute240_STX = add_indicators_version4(df_minute240_STX)
    df_minute240_ETC = add_indicators_version4(df_minute240_ETC)
    df_minute240_APT = add_indicators_version4(df_minute240_APT)
    df_minute240_MVL = add_indicators_version4(df_minute240_MVL)
    df_minute240_SXP = add_indicators_version4(df_minute240_SXP)
    df_minute240_AVAX = add_indicators_version4(df_minute240_AVAX) 
    df_minute240_BCH = add_indicators_version4(df_minute240_BCH)
    df_minute240_ICX = add_indicators_version4(df_minute240_ICX)
    df_minute240_SEI = add_indicators_version4(df_minute240_SEI)
    df_minute240_ONG = add_indicators_version4(df_minute240_ONG)
    df_minute240_BTG = add_indicators_version4(df_minute240_BTG)
    df_minute240_ORBS = add_indicators_version4(df_minute240_ORBS)
    df_minute240_ZRX = add_indicators_version4(df_minute240_ZRX)
    df_minute240_GMT = add_indicators_version4(df_minute240_GMT)
    df_minute240_HUNT = add_indicators_version4(df_minute240_HUNT)
    df_minute240_IOTA = add_indicators_version4(df_minute240_IOTA)
    df_minute240_IQ = add_indicators_version4(df_minute240_IQ)
    df_minute240_STRAX = add_indicators_version4(df_minute240_STRAX)
    df_minute240_CELO = add_indicators_version4(df_minute240_CELO)
    df_minute240_ARB = add_indicators_version4(df_minute240_ARB)
    df_minute240_BTT = add_indicators_version4(df_minute240_BTT)
    df_minute240_HBAR = add_indicators_version4(df_minute240_HBAR)
    df_minute240_LINK = add_indicators_version4(df_minute240_LINK)
    df_minute240_SAND = add_indicators_version4(df_minute240_SAND)
    df_minute240_GRT = add_indicators_version4(df_minute240_GRT)
    df_minute240_FLOW = add_indicators_version4(df_minute240_FLOW)
    df_minute240_ADA = add_indicators_version4(df_minute240_ADA)
    df_minute240_SUI = add_indicators_version4(df_minute240_SUI)

    ################################################################
    df_minute240_AQT = add_indicators_version4(df_minute240_AQT)
    df_minute240_CBK = add_indicators_version4(df_minute240_CBK)
    df_minute240_FCT2 = add_indicators_version4(df_minute240_FCT2)
    df_minute240_JST = add_indicators_version4(df_minute240_JST)
    df_minute240_UPP = add_indicators_version4(df_minute240_UPP)
    df_minute240_STRIKE = add_indicators_version4(df_minute240_STRIKE)
    df_minute240_MOC = add_indicators_version4(df_minute240_MOC)
    df_minute240_TFUEL = add_indicators_version4(df_minute240_TFUEL)
    df_minute240_TT = add_indicators_version4(df_minute240_TT)
    df_minute240_KNC = add_indicators_version4(df_minute240_KNC)
    df_minute240_CRO = add_indicators_version4(df_minute240_CRO)
    df_minute240_META = add_indicators_version4(df_minute240_META)
    df_minute240_ELF = add_indicators_version4(df_minute240_ELF)
    df_minute240_AHT = add_indicators_version4(df_minute240_AHT)
    df_minute240_BAT = add_indicators_version4(df_minute240_BAT)
    df_minute240_SBD = add_indicators_version4(df_minute240_SBD)
    df_minute240_MED = add_indicators_version4(df_minute240_MED)
    df_minute240_AAVE = add_indicators_version4(df_minute240_AAVE)
    df_minute240_XTZ = add_indicators_version4(df_minute240_XTZ)
    df_minute240_TON = add_indicators_version4(df_minute240_TON)

    ####################################################################33
    df_minute240_IMX = add_indicators_version4(df_minute240_IMX)
    df_minute240_HPO = add_indicators_version4(df_minute240_HPO)
    df_minute240_EGLD = add_indicators_version4(df_minute240_EGLD)
    df_minute240_HIVE = add_indicators_version4(df_minute240_HIVE)
    df_minute240_GRS = add_indicators_version4(df_minute240_GRS)
    df_minute240_QKC = add_indicators_version4(df_minute240_QKC)
    df_minute240_STPT = add_indicators_version4(df_minute240_STPT)
    df_minute240_XEM = add_indicators_version4(df_minute240_XEM)
    df_minute240_STEEM = add_indicators_version4(df_minute240_STEEM)
    df_minute240_ATOM = add_indicators_version4(df_minute240_ATOM)
    df_minute240_LOOM = add_indicators_version4(df_minute240_LOOM)
    df_minute240_1INCH = add_indicators_version4(df_minute240_1INCH)
    df_minute240_ARK = add_indicators_version4(df_minute240_ARK)
    df_minute240_ZIL = add_indicators_version4(df_minute240_ZIL)
    df_minute240_CRE = add_indicators_version4(df_minute240_CRE)
    df_minute240_MBL = add_indicators_version4(df_minute240_MBL)
    df_minute240_ALGO = add_indicators_version4(df_minute240_ALGO)
    df_minute240_STORJ = add_indicators_version4(df_minute240_STORJ)
    df_minute240_DKA = add_indicators_version4(df_minute240_DKA)
    df_minute240_XLM = add_indicators_version4(df_minute240_XLM)
    df_minute240_IOST = add_indicators_version4(df_minute240_IOST)
    df_minute240_ARDR = add_indicators_version4(df_minute240_ARDR)
    df_minute240_CHZ = add_indicators_version4(df_minute240_CHZ)
    df_minute240_MINA = add_indicators_version4(df_minute240_MINA)
    df_minute240_MANA = add_indicators_version4(df_minute240_MANA)
    df_minute240_KAVA = add_indicators_version4(df_minute240_KAVA)
    df_minute240_MASK = add_indicators_version4(df_minute240_MASK)
    df_minute240_BLUR = add_indicators_version4(df_minute240_BLUR)
    df_minute240_SNT = add_indicators_version4(df_minute240_SNT)
    df_minute240_POWR = add_indicators_version4(df_minute240_POWR)
    df_minute240_AXS = add_indicators_version4(df_minute240_AXS)
    df_minute240_DOT = add_indicators_version4(df_minute240_DOT)
    df_minute240_MTL = add_indicators_version4(df_minute240_MTL)
    df_minute240_ONT = add_indicators_version4(df_minute240_ONT)
    df_minute240_GLM = add_indicators_version4(df_minute240_GLM)
    df_minute240_MATIC = add_indicators_version4(df_minute240_MATIC)
    df_minute240_BSV = add_indicators_version4(df_minute240_BSV)
    df_minute240_EOS = add_indicators_version4(df_minute240_EOS)
    df_minute240_MLK = add_indicators_version4(df_minute240_MLK)
    df_minute240_THETA = add_indicators_version4(df_minute240_THETA)
    df_minute240_TRX = add_indicators_version4(df_minute240_TRX)
    df_minute240_ASTR = add_indicators_version4(df_minute240_ASTR)
    df_minute240_GAS = add_indicators_version4(df_minute240_GAS)
    df_minute240_WAVES = add_indicators_version4(df_minute240_WAVES)
    df_minute240_MNT = add_indicators_version4(df_minute240_MNT)
    df_minute240_VET = add_indicators_version4(df_minute240_VET)
    df_minute240_QTUM = add_indicators_version4(df_minute240_QTUM)
...
def make_decision_and_execute_sell(index_value):
    ...
    try:
        if isinstance(index_value, str): 
            ...
            df_minute240_index_value = add_indicators_version4(df_minute240_index_value)
